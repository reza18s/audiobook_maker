...
- Sentence deletion is project-scoped at `DELETE /v1/projects/{project_id}/sentences`; the gateway cancels attached generation jobs, removes generated audio within the project volume, and invalidates sentence/chapter/project counts in the client.
